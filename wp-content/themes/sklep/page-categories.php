                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            <a href="<? echo get_term_link(5) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand1.png" alt=""></a>
                            <a href="<? echo get_term_link(7) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand3.png" alt=""></a>
                            <a href="<? echo get_term_link(4) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand4.png" alt=""></a>
                            <a href="<? echo get_term_link(5) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand1.png" alt=""></a>
                            <a href="<? echo get_term_link(7) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand3.png" alt=""></a>
                            <a href="<? echo get_term_link(4) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand4.png" alt=""></a>
							<a href="<? echo get_term_link(5) ?>"><img src="<?php bloginfo('template_url') ?>/img/brand1.png" alt=""></a>
